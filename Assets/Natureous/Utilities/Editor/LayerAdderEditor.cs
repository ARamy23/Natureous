...
namespace Natureous
{
    ...
    public class LayerAdderEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button("Add Natureous Default Layers"))
            {
                NatureousLayer[] arr = System.Enum.GetValues(typeof(NatureousLayer)) as NatureousLayer[];

                foreach (NatureousLayer r in arr)
                {
